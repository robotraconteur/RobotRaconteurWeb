...
namespace RobotRaconteur
{
    public class CSharpServiceLangGen
    {
                ...
                w2.WriteLine("    {");
                {
                    ...
                    foreach (var m in MemberIter<PropertyDefinition>(e))
                    {
                        ...
                        if (DataTypeUtil.IsNumber(m.Type.Type))
                        {
                            ...
                            {
                                w2.WriteLine("    a.Array[a.Offset + " + i + "] = " + t8.name + ";");
                                i++;
                            }
                            else
                            {
                                w2.WriteLine("    Array.Copy(" + t8.name + ", 0, a.Array, a.Offset + " + i + ", " + t7.ArrayLength[0] + ");");
                                i += t7.ArrayLength[0];
                            }
                        }
                        else
                        {
                            ...
                            w2.WriteLine("    " + t8.name + ".GetNumericArray(ref a" + i + ");");
                            i += t9.Item2 * e2_count;
                ...
                w2.WriteLine("    {");
                {
                    ...
                    foreach (var m in MemberIter<PropertyDefinition>(e))
                    {
                        ...
                        if (DataTypeUtil.IsNumber(m.Type.Type))
                        {
                            if (m.Type.ArrayType == DataTypes_ArrayTypes.none)
                            {
                                w2.WriteLine("    " + t8.name + " = a.Array[a.Offset + " + i + "]" + ";");
                                i++;
                            }
                            else
                            {
                                w2.WriteLine("    Array.Copy(a.Array, a.Offset + " + i + ", " + t8.name + ", 0, " + t7.ArrayLength[0] + ");");
                                i += t7.ArrayLength[0];
                            }
                        }
                        else
                        {
                            ...
                            w2.WriteLine("    var a" + i + " = new ArraySegment<" + t6.cs_type + ">(a.Array, a.Offset + " + i + ", " + t9.Item2 * e2_count +");");
                            w2.WriteLine("    " + t8.name + ".AssignFromNumericArray(ref a" + i + ");");
                            i += t9.Item2 * e2_count;
        ...
        public static void GenerateInterfaceFile(ServiceDefinition d, TextWriter w2)
        {
            w2.WriteLine("//This file is automatically generated. DO NOT EDIT!");
            w2.WriteLine("using System;");
            w2.WriteLine("using RobotRaconteur;");
        ...
        public static void GenerateStubSkelFile(ServiceDefinition d, string defstring, TextWriter w2)
        {            
            w2.WriteLine("//This file is automatically generated. DO NOT EDIT!");
            w2.WriteLine("using System;");
            w2.WriteLine("using RobotRaconteur;");
