...
namespace RobotRaconteurTest
{
    public class LFSRSeqGen
    {
        ...
        public Array NextArrayByType(DataTypes dtype, uint len)
        {
            switch (dtype)
            {
                ...
                case DataTypes.string_t:
                    return UTF8Encoding.UTF8.GetBytes(NextString(len));
        ...
        public Array NextArrayByTypeVarLen(DataTypes dtype, uint max_len)
        {
            switch (dtype)
            {
                case DataTypes.int8_t:
                ...
                case DataTypes.string_t:
                    return UTF8Encoding.UTF8.GetBytes(NextStringVarLen(max_len));
                case DataTypes.bool_t:
